...
class mmi(imdb):
    def __init__(self, image_set, devkit_path):
        ...
        self._classes = ('__background__', 'Auto Parking', 'Bump Ahead', 'Bus Stop Ahead', 'Car And Taxi Parking', 'Compulsory Keep Left', 'Cross Road', 
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_mmi_annotation(index)
    ...
    def _load_mmi_annotation(self, index):
        """
        Load image and bounding boxes info from txt files of mmi.
        """
    ...
    def _write_mmi_results_file(self, all_boxes):
        for cls_ind, cls in enumerate(self.classes):
            if cls == '__background__':
                continue
            print 'Writing {} results file'.format(cls)
            filename = self._get_mmi_results_file_template().format(cls)
    ...
    def evaluate_detections(self, all_boxes, output_dir):
        self._write_mmi_results_file(all_boxes)
    ...
    def _get_mmi_results_file_template(self):
